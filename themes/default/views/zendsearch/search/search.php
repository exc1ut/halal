...
<div class="page">
    ...
    <?=CHtml::beginForm(['/zendsearch/search/search'], 'get', [
        ...
        <?=CHtml::textField('q', CHtml::encode($term), [
            'placeholder' => Yii::t('ZendSearchModule.zendsearch', 'Search...'),
            'class' => 'form-control'
        ]); ?>
        <?=CHtml::submitButton(Yii::t('ZendSearchModule.zendsearch', 'Find!'), [
        ...
        <?php foreach ($results as $result): ?>
            ...
            <h3>
                <?=$query->highlightMatches(
                    CHtml::link($result->title, 
                    CController::CreateUrl($resultLink, $paramsArray)),
                    'UTF-8'
                );?>
            </h3>
